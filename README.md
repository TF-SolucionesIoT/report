  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <strong>TF1:</strong> La construcción del prototipo físico y la programación de cada componente requirieron coordinar responsabilidades, compartir avances y resolver problemas de forma colaborativa. Integrar sensores, actuadores y lógica de control demandó comunicación clara y acuerdos técnicos comunes. La validación y el ajuste del sistema implicaron tomar decisiones en conjunto, alternando roles según conocimientos y necesidades del proyecto. Este proceso fortaleció el liderazgo compartido y la capacidad para orientar al equipo hacia un resultado funcional.<br><br>
    ...
    <tr>
      ...
      <td>
        ...
        <strong>TF1:</strong> La integración del prototipo físico y la programación de sus componentes favorecieron un entorno colaborativo e inclusivo al considerar aportes y habilidades de cada integrante. Definir metas de integración, planificar tareas por módulos y establecer criterios de validación permitió avanzar de manera ordenada. La comunicación continua y la documentación compartida facilitaron resolver fallas sin retrasar al equipo. Finalmente, el cumplimiento de los objetivos demostró la eficacia del trabajo coordinado y la planificación conjunta.<br><br>
        <b>Huapaya Cuevas, Anthony Martin:</b><br>
